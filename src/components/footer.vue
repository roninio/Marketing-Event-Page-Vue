      ...
      <div class="footer-copyright">
        <span class="footer-text23">
          <span>
            <span>
              © All rights reserved
              <span v-html="rawns1t"></span>
            </span>
            <span><span v-html="rawnt5y"></span></span>
          </span>
          <a
          ...
          <span>
            <span>
              Powered by
              <span v-html="rawq2xz"></span>
            </span>
            <span><span v-html="rawb7w0"></span></span>
          </span>
          <a
          ...
          <span>
            <span>
              . Image source:
              <span v-html="raw90pf"></span>
            </span>
            <span><span v-html="raww0eg"></span></span>
          </span>
          <a
